...
def load_colors():
    ...
    Add continuous colormaps Parula, Turbo. The Copyright of
    those are given on top of the data.

    """
    # register own continuous and discrete cmaps
    for colormap in [clr.ListedColormap(pastel5_array, name='pastel5'),
    ...
    # add continuous cmaps
    if version.parse(mpl.__version__) < version.parse('3.3.0'):
        for colormap in [__turbo(), __turbo().reversed()]:
            plt.register_cmap(cmap=colormap)
...
# gray tones
ufcd_grays = {'dark': '#4d4f53', 'light': '#b2b4b3'}
default_grays = {'dark': '#4d4f53', 'light': '#dddfe5'}


# ~~~ TRUBO CMAP ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# this is needed for matplotlib < 3.3.0
